...
HOST = "localhost"
PORT = 4223
UID = "6qX3zX"  # Change to the UID of your Servo Brick
...
while True:
    ...
    # if servo.get_current_position(0) == 4500:
    #     servo.set_position(0, 4500)  # Set to center position
    #     servo.enable(0)
    #
    #
    # if servo.get_current_position(0) == -4500:
