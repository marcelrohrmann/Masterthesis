...
class BrickServo(Device):
    ...
    def set_degree(self, servo_num: object, min: object, max: object) -> object:
        """
    ...
    def get_servo_current(self, servo_num: object) -> object:
        """
    ...
    def get_chip_temperature(self) -> object:
        """
