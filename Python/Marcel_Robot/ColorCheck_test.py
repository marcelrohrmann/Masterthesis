...
if read_expression.circle_color_number == 186:
    ...
    cv2.putText(red_result, "NX Color has changed. Not defined", (20, 180), cv2.FONT_HERSHEY_SIMPLEX, fontScale=1, color=(0,0,255), thickness=2)
...
if green_check_succesfull == True and red_check_succesfull == True:
    cv2.putText(blank_image, "Checks sucessfull", (120, 180), cv2.FONT_HERSHEY_SIMPLEX, fontScale=1, color=(0,0,255), thickness=2)
